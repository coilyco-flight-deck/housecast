# The grading page, color and type
...
geometry that breaks on reflow and color is not.
...
Each verdict carries a glyph, a word, and a color, the color weakest of the three. Pass and fit
